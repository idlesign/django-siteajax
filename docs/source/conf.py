# -*- coding: utf-8 -*-
#
# django-siteajax documentation build configuration file.
#
...
from siteajax import VERSION_STR
...
project = 'django-siteajax'
copyright = '2021-2023, Igor `idle sign` Starikov'
...
htmlhelp_basename = 'django-siteajaxdoc'
...
latex_documents = [
    (master_doc, 'django-siteajax.tex', 'django-siteajax Documentation',
